...
class Raycast2():
    def __init__(self,game):
        ...
        self.obj_to_reneder = []
        self.texture = self.game.object_renderer2.wall_texture
    ...
    def ray_cast(self):
        ...
        ray_angle = self.game.player2.angle - half_fov + 0.0001
        for ray in range(num_ray):
            ...
            for i in range(max_depth):
                ...
                if tile_hor in self.game.map2.world_map:
                    texture_hor = self.game.map2.world_map[tile_hor]
                    break
                x_hor += dx
                y_hor += dy
            ...
            for i in range(max_depth):
                ...
                if tile_vert in self.game.map2.world_map:
                    texture_vert = self.game.map2.world_map[tile_vert]
                    break
                x_vert += dx
                y_vert += dy
            ...
            depth *= math.cos(self.game.player2.angle - ray_angle)
