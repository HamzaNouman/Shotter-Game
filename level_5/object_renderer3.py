...
class objrend3():
    ...
    def draw_player_health(self):
        health = str(self.game.player3.health)
    ...
    def draw_background (self):
        self.sky_offset = (self.sky_offset + 4.5* self.game.player3.rel) % width
        self.screen.blit(self.sky_image , (-self.sky_offset,0))
        self.screen.blit(self.sky_image , (-self.sky_offset + width,0))
        pg.draw.rect(self.screen, floor_color , (0,half_height,width,height))
        
    def renderer_game_obj(self):
        list_obj = sorted(self.game.raycasting3.obj_to_reneder, key=lambda t: t[0], reverse=True)
